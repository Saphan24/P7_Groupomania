    ...
    <main>
        ...
        <div class="row justify-content-center mt-5">
            <b-jumbotron class="col-xl-4 col-lg-5 col-md-6">
                ...
                <div class="login-box">
                    <div class="alert alert-icon alert-danger justify-content-center" v-show="pwAlert" style="display: none;">Incorrect username or password</div>
                    <b-form-group> 
                        <label for="email">Email</label>
                        <b-form-input type="email" class="form-control" id="email" name="email" v-model="email" placeholder="name@example.com" :class="{ 'is-invalid': submitted && $v.email.$error }"></b-form-input>
                        <div v-if="submitted && !$v.email.required" class="invalid-feedback">Veuillez saisir votre email</div>
                    </b-form-group>
                    <b-form-group>
                        <label for="password">Password</label>
                        <b-form-input type="password" class="form-control" id="password" name="password" v-model="password" placeholder="••••••••••" :class="{ 'is-invalid': submitted && $v.password.$error }"></b-form-input>
                        <div v-if="submitted && $v.password.$error" class="invalid-feedback">Veuillez saisir votre mot de passe</div>
                    </b-form-group>
                    <div class="actions mt-4">
                        <b-button class="btn btn-rounded btn-lg btn-primary btn-block" v-on:click="onSubmit()">Se connecter</b-button>
                    </div>
                </div>
            </b-jumbotron>
        </div>
